...
MPIRUN_HOSTFILE_FLAG="--hostfile conf/aws-hpc_hostfile" # Flag for specifying the hostfile
MPIRUN_ADDITIONAL_FLAGS="-x FI_EFA_TX_MIN_CREDITS=1024"    # Any additional flag that must be used by mpirun
INTERFACE_MASK="10.0.0.250/20" # Interface address + mask size of the two nodes

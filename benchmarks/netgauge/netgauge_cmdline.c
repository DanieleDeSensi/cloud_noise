...
const char *netgauge_cmd_struct_help[] = {
  ...
  "  -n, --concurrent=INT       how many concurrent msg to send in the one_one ptrn (default=`1')",
...
void init_args_info(struct netgauge_cmd_struct *args_info)
{
  ...
  args_info->concurrent_help = netgauge_cmd_struct_help[10] ;
  args_info->mode_help = netgauge_cmd_struct_help[11] ;
  args_info->comm_pattern_help = netgauge_cmd_struct_help[12] ;
  args_info->grad_help = netgauge_cmd_struct_help[13] ;
  args_info->manpage_help = netgauge_cmd_struct_help[14] ;
  args_info->init_thread_help = netgauge_cmd_struct_help[15] ;
  args_info->sanity_check_help = netgauge_cmd_struct_help[16] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vhv:ao:f:c:t:s:n:m:x:g:wiq", long_options, &option_index);

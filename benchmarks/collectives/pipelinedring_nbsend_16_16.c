...
int main(int argc, char** argv){
    ...
    for(i = -10; i < 10000; i++){
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 1, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 2, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 3, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 4, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 5, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 6, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 7, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 8, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 9, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 10, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 11, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 12, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 13, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 14, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 15, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 8, MPI_COMM_WORLD, &(mpi_reqs[18]));
        MPI_Wait(&(mpi_reqs[17]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 9, MPI_COMM_WORLD, &(mpi_reqs[20]));
        MPI_Wait(&(mpi_reqs[19]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 10, MPI_COMM_WORLD, &(mpi_reqs[22]));
        MPI_Wait(&(mpi_reqs[21]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 11, MPI_COMM_WORLD, &(mpi_reqs[24]));
        MPI_Wait(&(mpi_reqs[23]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 12, MPI_COMM_WORLD, &(mpi_reqs[26]));
        MPI_Wait(&(mpi_reqs[25]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 13, MPI_COMM_WORLD, &(mpi_reqs[28]));
        MPI_Wait(&(mpi_reqs[27]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 14, MPI_COMM_WORLD, &(mpi_reqs[30]));
        MPI_Wait(&(mpi_reqs[29]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 1, MPI_BYTE, 0, 15, MPI_COMM_WORLD, &(mpi_reqs[32]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[31]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);

...
int main(int argc, char** argv){
    ...
    for(i = -10; i < 10000; i++){
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 1, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 2, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 3, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 4, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 5, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 6, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 7, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);
        ...
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 0, MPI_COMM_WORLD, &(mpi_reqs[2]));
        do{
        MPI_Wait(&(mpi_reqs[1]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 1, MPI_COMM_WORLD, &(mpi_reqs[4]));
        MPI_Wait(&(mpi_reqs[3]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 2, MPI_COMM_WORLD, &(mpi_reqs[6]));
        MPI_Wait(&(mpi_reqs[5]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 3, MPI_COMM_WORLD, &(mpi_reqs[8]));
        MPI_Wait(&(mpi_reqs[7]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 4, MPI_COMM_WORLD, &(mpi_reqs[10]));
        MPI_Wait(&(mpi_reqs[9]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 5, MPI_COMM_WORLD, &(mpi_reqs[12]));
        MPI_Wait(&(mpi_reqs[11]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 6, MPI_COMM_WORLD, &(mpi_reqs[14]));
        MPI_Wait(&(mpi_reqs[13]), MPI_STATUS_IGNORE);
        MPI_Isend(buffer, 2, MPI_BYTE, 0, 7, MPI_COMM_WORLD, &(mpi_reqs[16]));
        }while(completed_tot < 0);
        MPI_Wait(&(mpi_reqs[15]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[2]), MPI_STATUS_IGNORE);
        MPI_Wait(&(mpi_reqs[4]), MPI_STATUS_IGNORE);

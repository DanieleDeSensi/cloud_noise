...
struct gengetopt_args_info
{
  ...
  int LogGOPS_L_far_arg;	/**< @brief The latency parameter L in the LogGP model (for different racks) (default='2500').  */
  char * LogGOPS_L_far_orig;	/**< @brief The latency parameter L in the LogGP model (for different racks) original value given at command line.  */
  const char *LogGOPS_L_far_help; /**< @brief The latency parameter L in the LogGP model (for different racks) help description.  */
  char * LogGOPS_Lfile_arg;	/**< @brief File of L measurements. For each communication, the actual L is selected randomly.  */
  char * LogGOPS_Lfile_orig;	/**< @brief File of L measurements. For each communication, the actual L is selected randomly original value given at command line.  */
  const char *LogGOPS_Lfile_help; /**< @brief File of L measurements. For each communication, the actual L is selected randomly help description.  */
  char * LogGOPS_Lfile_far_arg;	/**< @brief File of L measurements (for different racks). For each communication, the actual L is selected randomly.  */
  char * LogGOPS_Lfile_far_orig;	/**< @brief File of L measurements (for different racks). For each communication, the actual L is selected randomly original value given at command line.  */
  const char *LogGOPS_Lfile_far_help; /**< @brief File of L measurements (for different racks). For each communication, the actual L is selected randomly help description.  */
  ...
  int LogGOPS_G_far_arg;	/**< @brief The gap per byte parameter G in the LogGP model (for different racks) (default='6').  */
  char * LogGOPS_G_far_orig;	/**< @brief The gap per byte parameter G in the LogGP model (for different racks) original value given at command line.  */
  const char *LogGOPS_G_far_help; /**< @brief The gap per byte parameter G in the LogGP model (for different racks) help description.  */
  char * LogGOPS_Gfile_arg;	/**< @brief File of G measurements. For each communication, the actual G is selected randomly.  */
  char * LogGOPS_Gfile_orig;	/**< @brief File of G measurements. For each communication, the actual G is selected randomly original value given at command line.  */
  const char *LogGOPS_Gfile_help; /**< @brief File of G measurements. For each communication, the actual G is selected randomly help description.  */
  char * LogGOPS_Gfile_far_arg;	/**< @brief File of G measurements (for different racks). For each communication, the actual G is selected randomly.  */
  char * LogGOPS_Gfile_far_orig;	/**< @brief File of G measurements (for different racks). For each communication, the actual G is selected randomly original value given at command line.  */
  const char *LogGOPS_Gfile_far_help; /**< @brief File of G measurements (for different racks). For each communication, the actual G is selected randomly help description.  */
  ...
  int nodes_per_switch_arg;	/**< @brief Number of nodes per switch (default='1').  */
  char * nodes_per_switch_orig;	/**< @brief Number of nodes per switch original value given at command line.  */
  const char *nodes_per_switch_help; /**< @brief Number of nodes per switch help description.  */
  ...
  int seed_arg;	/**< @brief Seed for the random selection of Ls and Gs (default='0').  */
  char * seed_orig;	/**< @brief Seed for the random selection of Ls and Gs original value given at command line.  */
  const char *seed_help; /**< @brief Seed for the random selection of Ls and Gs help description.  */
  ...
  unsigned int LogGOPS_L_far_given ;	/**< @brief Whether LogGOPS_L_far was given.  */
  unsigned int LogGOPS_Lfile_given ;	/**< @brief Whether LogGOPS_Lfile was given.  */
  unsigned int LogGOPS_Lfile_far_given ;	/**< @brief Whether LogGOPS_Lfile_far was given.  */
  ...
  unsigned int LogGOPS_G_given ;	/**< @brief Whether LogGOPS_G was given.  */
  unsigned int LogGOPS_G_far_given ;	/**< @brief Whether LogGOPS_G_far was given.  */
  unsigned int LogGOPS_Gfile_given ;	/**< @brief Whether LogGOPS_Gfile was given.  */
  unsigned int LogGOPS_Gfile_far_given ;	/**< @brief Whether LogGOPS_Gfile_far was given.  */
  unsigned int LogGOPS_S_given ;	/**< @brief Whether LogGOPS_S was given.  */
  unsigned int LogGOPS_O_given ;	/**< @brief Whether LogGOPS_O was given.  */
  unsigned int nodes_per_switch_given ;	/**< @brief Whether nodes_per_switch was given.  */

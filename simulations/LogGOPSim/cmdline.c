...
const char *gengetopt_args_info_help[] = {
  ...
  "      --LogGOPS_L_far=INT       The latency parameter L in the LogGP model (for\n                                  different racks)  (default=`2500')",
  "      --LogGOPS_Lfile=STRING    File of L measurements. For each communication,\n                                  the actual L is selected randomly",
  "      --LogGOPS_Lfile_far=STRING\n                                File of L measurements (for different racks).\n                                  For each communication, the actual L is\n                                  selected randomly",
  ...
  "      --LogGOPS_G_far=INT       The gap per byte parameter G in the LogGP model\n                                  (for different racks)  (default=`6')",
  "      --LogGOPS_Gfile=STRING    File of G measurements. For each communication,\n                                  the actual G is selected randomly",
  "      --LogGOPS_Gfile_far=STRING\n                                File of G measurements (for different racks).\n                                  For each communication, the actual G is\n                                  selected randomly",
  ...
  "      --nodes_per_switch=INT    Number of nodes per switch  (default=`1')",
  ...
  "      --qstat=STRING            Enable PQ and UQ statistics.  Argument is\n                                  output filename prefix  (default=`Unknown')",
  "      --seed=INT                Seed for the random selection of Ls and Gs\n                                  (default=`0')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->LogGOPS_L_far_given = 0 ;
  args_info->LogGOPS_Lfile_given = 0 ;
  args_info->LogGOPS_Lfile_far_given = 0 ;
  args_info->LogGOPS_o_given = 0 ;
  args_info->LogGOPS_g_given = 0 ;
  args_info->LogGOPS_G_given = 0 ;
  args_info->LogGOPS_G_far_given = 0 ;
  args_info->LogGOPS_Gfile_given = 0 ;
  args_info->LogGOPS_Gfile_far_given = 0 ;
  args_info->LogGOPS_S_given = 0 ;
  args_info->LogGOPS_O_given = 0 ;
  args_info->nodes_per_switch_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->LogGOPS_L_far_arg = 2500;
  args_info->LogGOPS_L_far_orig = NULL;
  args_info->LogGOPS_Lfile_arg = NULL;
  args_info->LogGOPS_Lfile_orig = NULL;
  args_info->LogGOPS_Lfile_far_arg = NULL;
  args_info->LogGOPS_Lfile_far_orig = NULL;
  ...
  args_info->LogGOPS_G_orig = NULL;
  args_info->LogGOPS_G_far_arg = 6;
  args_info->LogGOPS_G_far_orig = NULL;
  args_info->LogGOPS_Gfile_arg = NULL;
  args_info->LogGOPS_Gfile_orig = NULL;
  args_info->LogGOPS_Gfile_far_arg = NULL;
  args_info->LogGOPS_Gfile_far_orig = NULL;
  args_info->LogGOPS_S_arg = 65535;
  args_info->LogGOPS_S_orig = NULL;
  args_info->LogGOPS_O_arg = 0;
  args_info->LogGOPS_O_orig = NULL;
  args_info->nodes_per_switch_arg = 1;
  args_info->nodes_per_switch_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->LogGOPS_L_far_help = gengetopt_args_info_help[5] ;
  args_info->LogGOPS_Lfile_help = gengetopt_args_info_help[6] ;
  args_info->LogGOPS_Lfile_far_help = gengetopt_args_info_help[7] ;
  args_info->LogGOPS_o_help = gengetopt_args_info_help[8] ;
  args_info->LogGOPS_g_help = gengetopt_args_info_help[9] ;
  args_info->LogGOPS_G_help = gengetopt_args_info_help[10] ;
  args_info->LogGOPS_G_far_help = gengetopt_args_info_help[11] ;
  args_info->LogGOPS_Gfile_help = gengetopt_args_info_help[12] ;
  args_info->LogGOPS_Gfile_far_help = gengetopt_args_info_help[13] ;
  args_info->LogGOPS_S_help = gengetopt_args_info_help[14] ;
  args_info->LogGOPS_O_help = gengetopt_args_info_help[15] ;
  args_info->nodes_per_switch_help = gengetopt_args_info_help[16] ;
  args_info->vizfile_help = gengetopt_args_info_help[17] ;
  args_info->verbose_help = gengetopt_args_info_help[18] ;
  args_info->progress_help = gengetopt_args_info_help[19] ;
  args_info->batchmode_help = gengetopt_args_info_help[20] ;
  args_info->noise_trace_help = gengetopt_args_info_help[21] ;
  args_info->noise_cosched_help = gengetopt_args_info_help[22] ;
  args_info->network_type_help = gengetopt_args_info_help[23] ;
  args_info->network_file_help = gengetopt_args_info_help[24] ;
  args_info->qstat_help = gengetopt_args_info_help[25] ;
  args_info->seed_help = gengetopt_args_info_help[26] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->LogGOPS_L_far_orig));
  free_string_field (&(args_info->LogGOPS_Lfile_arg));
  free_string_field (&(args_info->LogGOPS_Lfile_orig));
  free_string_field (&(args_info->LogGOPS_Lfile_far_arg));
  free_string_field (&(args_info->LogGOPS_Lfile_far_orig));
  free_string_field (&(args_info->LogGOPS_o_orig));
  free_string_field (&(args_info->LogGOPS_g_orig));
  free_string_field (&(args_info->LogGOPS_G_orig));
  free_string_field (&(args_info->LogGOPS_G_far_orig));
  free_string_field (&(args_info->LogGOPS_Gfile_arg));
  free_string_field (&(args_info->LogGOPS_Gfile_orig));
  free_string_field (&(args_info->LogGOPS_Gfile_far_arg));
  free_string_field (&(args_info->LogGOPS_Gfile_far_orig));
  free_string_field (&(args_info->LogGOPS_S_orig));
  free_string_field (&(args_info->LogGOPS_O_orig));
  free_string_field (&(args_info->nodes_per_switch_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->LogGOPS_L_far_given)
    write_into_file(outfile, "LogGOPS_L_far", args_info->LogGOPS_L_far_orig, 0);
  if (args_info->LogGOPS_Lfile_given)
    write_into_file(outfile, "LogGOPS_Lfile", args_info->LogGOPS_Lfile_orig, 0);
  if (args_info->LogGOPS_Lfile_far_given)
    write_into_file(outfile, "LogGOPS_Lfile_far", args_info->LogGOPS_Lfile_far_orig, 0);
  ...
  if (args_info->LogGOPS_G_given)
    write_into_file(outfile, "LogGOPS_G", args_info->LogGOPS_G_orig, 0);
  if (args_info->LogGOPS_G_far_given)
    write_into_file(outfile, "LogGOPS_G_far", args_info->LogGOPS_G_far_orig, 0);
  if (args_info->LogGOPS_Gfile_given)
    write_into_file(outfile, "LogGOPS_Gfile", args_info->LogGOPS_Gfile_orig, 0);
  if (args_info->LogGOPS_Gfile_far_given)
    write_into_file(outfile, "LogGOPS_Gfile_far", args_info->LogGOPS_Gfile_far_orig, 0);
  if (args_info->LogGOPS_S_given)
    write_into_file(outfile, "LogGOPS_S", args_info->LogGOPS_S_orig, 0);
  if (args_info->LogGOPS_O_given)
    write_into_file(outfile, "LogGOPS_O", args_info->LogGOPS_O_orig, 0);
  if (args_info->nodes_per_switch_given)
    write_into_file(outfile, "nodes_per_switch", args_info->nodes_per_switch_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "save-mem",	0, NULL, 0 },
        { "LogGOPS_L",	1, NULL, 'L' },
        { "LogGOPS_L_far",	1, NULL, 0 },
        { "LogGOPS_Lfile",	1, NULL, 0 },
        { "LogGOPS_Lfile_far",	1, NULL, 0 },
        { "LogGOPS_o",	1, NULL, 'o' },
        { "LogGOPS_g",	1, NULL, 'g' },
        { "LogGOPS_G",	1, NULL, 'G' },
        { "LogGOPS_G_far",	1, NULL, 0 },
        { "LogGOPS_Gfile",	1, NULL, 0 },
        { "LogGOPS_Gfile_far",	1, NULL, 0 },
        { "LogGOPS_S",	1, NULL, 'S' },
        { "LogGOPS_O",	1, NULL, 'O' },
        { "nodes_per_switch",	1, NULL, 0 },
        { "vizfile",	1, NULL, 'V' },
        { "verbose",	0, NULL, 'v' },
        { "progress",	0, NULL, 0 },
        { "batchmode",	0, NULL, 'b' },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* The latency parameter L in the LogGP model (for different racks).  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_L_far") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_L_far_arg), 
                 &(args_info->LogGOPS_L_far_orig), &(args_info->LogGOPS_L_far_given),
                &(local_args_info.LogGOPS_L_far_given), optarg, 0, "2500", ARG_INT,
                check_ambiguity, override, 0, 0,
                "LogGOPS_L_far", '-',
                additional_error))
              goto failure;
          ...
          /* File of L measurements. For each communication, the actual L is selected randomly.  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_Lfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_Lfile_arg), 
                 &(args_info->LogGOPS_Lfile_orig), &(args_info->LogGOPS_Lfile_given),
                &(local_args_info.LogGOPS_Lfile_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "LogGOPS_Lfile", '-',
                additional_error))
              goto failure;
          ...
          /* File of L measurements (for different racks). For each communication, the actual L is selected randomly.  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_Lfile_far") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_Lfile_far_arg), 
                 &(args_info->LogGOPS_Lfile_far_orig), &(args_info->LogGOPS_Lfile_far_given),
                &(local_args_info.LogGOPS_Lfile_far_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "LogGOPS_Lfile_far", '-',
                additional_error))
              goto failure;
          ...
          /* The gap per byte parameter G in the LogGP model (for different racks).  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_G_far") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_G_far_arg), 
                 &(args_info->LogGOPS_G_far_orig), &(args_info->LogGOPS_G_far_given),
                &(local_args_info.LogGOPS_G_far_given), optarg, 0, "6", ARG_INT,
                check_ambiguity, override, 0, 0,
                "LogGOPS_G_far", '-',
                additional_error))
              goto failure;
          ...
          /* File of G measurements. For each communication, the actual G is selected randomly.  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_Gfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_Gfile_arg), 
                 &(args_info->LogGOPS_Gfile_orig), &(args_info->LogGOPS_Gfile_given),
                &(local_args_info.LogGOPS_Gfile_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "LogGOPS_Gfile", '-',
                additional_error))
              goto failure;
          ...
          /* File of G measurements (for different racks). For each communication, the actual G is selected randomly.  */
          else if (strcmp (long_options[option_index].name, "LogGOPS_Gfile_far") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->LogGOPS_Gfile_far_arg), 
                 &(args_info->LogGOPS_Gfile_far_orig), &(args_info->LogGOPS_Gfile_far_given),
                &(local_args_info.LogGOPS_Gfile_far_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "LogGOPS_Gfile_far", '-',
                additional_error))
              goto failure;
          ...
          /* Number of nodes per switch.  */
          else if (strcmp (long_options[option_index].name, "nodes_per_switch") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->nodes_per_switch_arg), 
                 &(args_info->nodes_per_switch_orig), &(args_info->nodes_per_switch_given),
                &(local_args_info.nodes_per_switch_given), optarg, 0, "1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "nodes_per_switch", '-',
                additional_error))
              goto failure;
          ...
          /* Seed for the random selection of Ls and Gs.  */

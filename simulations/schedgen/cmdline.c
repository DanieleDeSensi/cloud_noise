...
const char *cmdline_parser_ptrn_values[] = {"binomialtreereduce", "binarytreebcast", "binomialtreebcast", "nwaydissemination", "pipelinedring", "pipelinedringdep", "doublering", "gather", "scatter", "linbarrier", "trace", "dissemination", "random_bisect", "random_bisect_fd_sym", "linear_alltoall", "pingpong", 0}; /*< Possible values for ptrn. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->traces_help = gengetopt_args_info_help[13] ;
  args_info->traces_start_help = gengetopt_args_info_help[14] ;
  args_info->traces_nops_help = gengetopt_args_info_help[15] ;
  args_info->traces_extr_help = gengetopt_args_info_help[16] ;
  args_info->traces_print_help = gengetopt_args_info_help[17] ;
  args_info->traces_nop2p_help = gengetopt_args_info_help[18] ;
  args_info->traces_nocolls_help = gengetopt_args_info_help[19] ;
  args_info->traces_nbcify_help = gengetopt_args_info_help[20] ;
